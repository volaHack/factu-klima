...
import { cargarContabilidad, type Contabilidad } from '@/lib/contabilidad/cargar';
import {
...
export default function ContabilidadPage() {
  ...
  return (
    <div className="page conta">
      <div className="page-header">
        <div className="page-header-left">
          ...
          <p className="page-subtitle">
            Cada factura, compra, gasto, cobro y venta del TPV ya tiene su asiento en el Plan General Contable.
      ...
      {pestana === 'diario' && <Diario asientos={delPeriodo} nombre={nombre} onExportar={() => descargar(diarioCsv(delPeriodo, nombre), `diario_${sufijo}.csv`)} />}
...
function Diario({ asientos, nombre, onExportar }: { asientos: Asiento[]; nombre: (c: string) => string; onExportar: () => void }) {
